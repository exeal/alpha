	...
	namespace graphics {
		namespace font {
			...
			ASCENSION_SCOPED_ENUM_DECLARE_BEGIN(LineRelativeDirection)
				/// 'over' means nominally the side that corresponds to the ascender side or gtoph side of a line box.
				OVER,
				/// 'under' means opposite of 'over': the line-relative gbottomh or descender side.
				UNDER,
