			...
			namespace sbcs {
				namespace {
						...
						Installer() {
							...
							EncoderRegistry::instance().registerFactory(std::make_shared<
								SingleByteEncoderFactory<
									...
									>
								>
							>("TCVN", MIB_OTHER, "Vietnamese (TCVN)", "", 0x1a));
							...
							EncoderRegistry::instance().registerFactory(std::make_shared<
								SingleByteEncoderFactory<
									...
									>
								>
							>("windows-1258", proprietary::WINDOWS_1258, "Vietnamese (Windows)", "\0ibm-5354|cp1258|ibm-5354_P100-1998", 0x3f));
							...
							EncoderRegistry::instance().registerFactory(std::make_shared<
								SingleByteEncoderFactory<
									...
									>
								>
							>("IBM1163", MIB_OTHER, "Vietnamese (IBM1163)", "\0ibm-1163_P100-1999", 0x1a));
					...
					Encoder::Result VIQREncoder::doFromUnicode(State& state,
						...
						static const std::ptrdiff_t VISCII_TO_VIQR_INDICES[16 * 16 + 1] = {
