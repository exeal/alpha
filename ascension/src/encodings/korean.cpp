...
#include "generated/windows-949-to-ucs.dat"
	...
	private:
		unique_ptr<Encoder> create() const BOOST_NOEXCEPT {return unique_ptr<Encoder>(new InternalEncoder<UHC>(*this));}
	} uhc;

	class EUC_KR : public EncoderFactoryBase {
	public:
		EUC_KR() BOOST_NOEXCEPT : EncoderFactoryBase("EUC-KR", standard::EUC_KR, "Korean (EUC-KR)", 2, 1,
			"csEUCKR" "\0ibm-970KS_C_5601-1987|windows-51949|ibm-eucKR|KSC_5601|5601|cp970|970|ibm-970-VPUA|ibm-970_P110_P110-2006_U2") {}
	private:
		unique_ptr<Encoder> create() const BOOST_NOEXCEPT {return unique_ptr<Encoder>(new InternalEncoder<EUC_KR>(*this));}
	} euckr;

	class ISO_2022_KR : public EncoderFactoryBase {
	public:
		ISO_2022_KR() BOOST_NOEXCEPT : EncoderFactoryBase("ISO-2022-KR", standard::ISO_2022_KR, "Korean (ISO-2022-KR)", 7, 1, "csISO2022KR") {}
	private:
		unique_ptr<Encoder> create() const BOOST_NOEXCEPT {return unique_ptr<Encoder>(new InternalEncoder<ISO_2022_KR>(*this));}
	} iso2022kr;
