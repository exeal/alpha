...
namespace ascension {
	namespace presentation {
		...
		/**
		 * [Copied from SVG 1.1 documentation] Sets the value as a floating point value, in user units. Setting this
		 * attribute will cause @c #valueInSpecifiedUnits() and @c #valueAsString() to be updated automatically to
