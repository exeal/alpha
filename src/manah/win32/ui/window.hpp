...
public:
	...
	static Window	find(const TCHAR* className, const TCHAR* windowName);
...
inline int Window::enumerateProperties(::PROPENUMPROC enumFunction) {assertValidAsWindow(); return ::EnumProps(getHandle(), enumFunction);}

inline int Window::enumeratePropertiesEx(::PROPENUMPROCEX enumFunction, LPARAM param) {assertValidAsWindow(); return ::EnumPropsEx(getHandle(), enumFunction, param);}

inline Window Window::find(const TCHAR* className, const TCHAR* windowName) {return Window(::FindWindow(className, windowName));}
...
inline int Window::getClassName(TCHAR* className, int maxLength) const {assertValidAsWindow(); return ::GetClassName(getHandle(), className, maxLength);}
...
inline HFONT Window::getFont() const {return reinterpret_cast<HFONT>(::SendMessage(getHandle(), WM_GETFONT, 0, 0L));}

inline Window Window::getForeground() {return Window(::GetForegroundWindow());}

inline DWORD Window::getHotKey() const {return static_cast<DWORD>(::SendMessage(getHandle(), WM_GETHOTKEY, 0, 0L));}

inline HICON Window::getIcon(bool bigIcon /* = true */) const {
	return reinterpret_cast<HICON>(::SendMessage(getHandle(), WM_GETICON, bigIcon ? ICON_BIG : ICON_SMALL, 0L));}
...
inline HANDLE Window::getProperty(const TCHAR* identifier) const {assertValidAsWindow(); return ::GetProp(getHandle(), identifier);}
...
inline int Window::getText(TCHAR* text, int maxLength) const {assertValidAsWindow(); return ::GetWindowText(getHandle(), text, maxLength);}
...
inline int Window::messageBox(const TCHAR* text, const TCHAR* caption /* = 0 */, UINT type /* = MB_OK */) {
	assertValidAsWindow(); return ::MessageBox(getHandle(), text, caption, type);}
...
inline LRESULT Window::postMessage(UINT message, WPARAM wParam /* = 0 */, LPARAM lParam /* = 0L */) {
	assertValidAsWindow(); return ::PostMessage(getHandle(), message, wParam, lParam);}
...
inline HANDLE Window::removeProperty(const TCHAR* identifier) {assertValidAsWindow(); return ::RemoveProp(getHandle(), identifier);}
...
inline LRESULT Window::sendMessage(UINT message, WPARAM wParam /* = 0 */, LPARAM lParam /* = 0L */) {
	assertValidAsWindow(); return ::SendMessage(getHandle(), message, wParam, lParam);}

inline bool Window::sendNotifyMessage(UINT message, WPARAM wParam, LPARAM lParam) {
	assertValidAsWindow(); return toBoolean(::SendNotifyMessage(getHandle(), message, wParam, lParam));}
...
inline bool Window::setProperty(const TCHAR* identifier, HANDLE data) {
	assertValidAsWindow(); return toBoolean(::SetProp(getHandle(), identifier, data));}
...
inline void Window::setText(const TCHAR* text) {assertValidAsWindow(); ::SetWindowText(getHandle(), text);}
...
inline bool Window::winHelp(const TCHAR* help, UINT command /* = HELP_CONTEXT */, DWORD data /* = 0 */) {
	return toBoolean(::WinHelp(getHandle(), help, command, data));}
