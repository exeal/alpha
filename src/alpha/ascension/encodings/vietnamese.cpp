...
namespace {
	...
	struct Installer {
		Installer() {
			...
			Encoder::registerEncoder(auto_ptr<Encoder>(new SingleByteEncoder("VISCII", extended::VISCII, "", VISCII_80, VISCII_00)));
//			Encoder::registerEncoder(auto_ptr<Encoder>(new ));
			Encoder::registerEncoder(auto_ptr<Encoder>(new SingleByteEncoder("TCVN", extended::TCVN, "", TCVN_80, TCVN_00)));
			Encoder::registerEncoder(auto_ptr<Encoder>(new SingleByteEncoder("VPS", extended::VPS, "", VPS_80, VPS_00)));
		}
	} installer;
} // namespace @0
