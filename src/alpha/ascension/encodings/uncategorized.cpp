...
namespace {
	...
	struct Installer {
		Installer() {
			...
			Encoder::registerEncoder(auto_ptr<Encoder>(new SingleByteEncoder("Nextstep", MIB_OTHER, "", 0x1A, NEXTSTEP)));
			Encoder::registerEncoder(auto_ptr<Encoder>(new SingleByteEncoder("Atarist ST/TT", MIB_OTHER, "", 0x1A, ATARIST)));
		}
	} installer;
} // namespace @0
