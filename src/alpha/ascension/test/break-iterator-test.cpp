// automatically generated by `perl gen-uax29-test.pl` at $ Sun Jan 14 20:17:53 2007 $
	...
	inline void checkWBI(const ascension::String& s, const std::vector<std::size_t>& indices) {
		...
		return check<ascension::unicode::WordBreakIterator>(
			ascension::unicode::WordBreakIterator<ascension::unicode::CStringCharacterIterator>(
				text, ascension::unicode::AbstractWordBreakIterator::BOUNDARY_OF_SEGMENT, ascension::unicode::CharacterDetector()), indices);
	}

	inline void checkSBI(const ascension::String& s, const std::vector<std::size_t>& indices) {
		ascension::unicode::CStringCharacterIterator text(s.data(), s.data(), s.data() + s.length());
		return check<ascension::unicode::SentenceBreakIterator>(
			ascension::unicode::SentenceBreakIterator<ascension::unicode::CStringCharacterIterator>(
				text, ascension::unicode::AbstractSentenceBreakIterator::BOUNDARY_OF_SEGMENT, ascension::unicode::CharacterDetector()), indices);
	}
}
